...
//        	usuario8.setNombre("Pedro");
//        	usuario8.setUsername("pedrousuario");
//        	usuario8.setEmail("pedro@usuario.com");
//        	usuario8.setClave(passwordEncoder.encode("12345678"));
//        	usuario8.setTelefono("334422999");
//        	usuario8.setFotoPerfil("assets/terapeuta2.jpg");
//        	usuario8.setRol(Set.of(Rol.USER));
//        	usuario8.setFechaNacimiento(LocalDate.of(1955, 8, 20));
//        	usuario8.setUbicacion("Alicante");
